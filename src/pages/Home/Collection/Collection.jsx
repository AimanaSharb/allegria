        ...
        <section className="collection">
            <div className="collection__content">
                <div className="collection__left">
                    ...
                    <p className="collection__left-desc">Lorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipLorem ipsumLorem ipLorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipLorem ipsumLorem ip</p>
                    <a href="" className="collection__left-link">{t("collection.link")}</a>
                </div>
